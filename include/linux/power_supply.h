...
enum power_supply_property {
	...
	/* Lenovo/MediaTek SC8551 charge-pump properties */
	...
	POWER_SUPPLY_PROP_SC_PPS_SUPPORTED,
	/* Lenovo/MediaTek LN8000 charge-pump properties */
	POWER_SUPPLY_PROP_TI_CHARGING_ENABLED,
